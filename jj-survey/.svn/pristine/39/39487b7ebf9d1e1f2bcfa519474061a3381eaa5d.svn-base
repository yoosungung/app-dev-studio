...
@Entity
@Table(name = "survey_velocity_template")
@NamedQueries({ @NamedQuery(name = "VelocityTemplate.findAll", query = "select o from VelocityTemplate o"),
...
public class VelocityTemplate implements Serializable {
    ...
    @Id
    // @SequenceGenerator(name = "seqVelocityTemplate",
    // sequenceName="seq_survey_velocity_template")
