...
@Entity
@NamedQueries({ @NamedQuery(name = "SurveyDocument.findById", query = "select o from SurveyDocument o where o.id = ?1"),
...
public class SurveyDocument implements Serializable {
    ...
    @Id
    // @SequenceGenerator(name = "seqServeyDocument",
    // sequenceName="seq_servey_document")
