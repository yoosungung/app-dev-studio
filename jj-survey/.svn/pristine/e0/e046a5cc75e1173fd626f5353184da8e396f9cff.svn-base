...
public class DateTimeFormatAnnotationFormatterFactory
        implements AnnotationFormatterFactory<DateTimeFormat>, ApplicationContextAware {
     ...
     * addFormatterForFieldType rules exist for each of these types (if we did not
     * do this, the default byType rules for LocalDate, LocalTime, and LocalDateTime
     * would take precedence over the annotation rule, which is not what we want)
     *
    ...
    public final class DatePrinter implements Printer<Date>, Parser<Date> {
        ...
        private String evaluateExpression(String expression) {
            Object value = beanFactory.getBeanExpressionResolver().evaluate(expression,
