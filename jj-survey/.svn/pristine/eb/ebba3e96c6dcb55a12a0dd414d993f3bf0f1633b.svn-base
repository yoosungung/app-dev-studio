...
public class SurveyDefinitionDAOImpl extends AbstractJpaDao<SurveyDefinition> implements SurveyDefinitionDAO {
    ...
    private final static Set<Class<?>> dataTypes = new HashSet<Class<?>>(
            Arrays.asList(new Class<?>[] { SurveyDefinition.class }));
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Set<SurveyDefinition> findAllInternal(String login, int startResult, int maxRows)
            throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.findAllForManagerInternal", startResult, maxRows);
        query.setParameter("login", login);
        return new LinkedHashSet<SurveyDefinition>(query.getResultList());
    }

    @Override
    public Set<SurveyDefinition> findAllForUserListInternal() throws DataAccessException {
        return findAllForUserListInternal(-1, -1);
    }

    @SuppressWarnings("unchecked")
    @Override
    public Set<SurveyDefinition> findAllForUserListInternal(int startResult, int maxRows) throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.findAllForUserListInternal", startResult, maxRows);
        return new LinkedHashSet<SurveyDefinition>(query.getResultList());
    }

    @Override
    public Set<SurveyDefinition> findAllForUserListInternal(String login) throws DataAccessException {
        return findAllForUserListInternal(login, -1, -1);
    }

    @SuppressWarnings("unchecked")
    @Override
    public Set<SurveyDefinition> findAllForUserListInternal(String login, int startResult, int maxRows)
            throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.findAllForManagerInternal", startResult, maxRows);
        query.setParameter("login", login);
        return new LinkedHashSet<SurveyDefinition>(query.getResultList());
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Set<SurveyDefinition> findAllCompletedInternal(String login, int startResult, int maxRows)
            throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.findAllCompletedForManagerInternal", startResult, maxRows);
        query.setParameter("login", login);
        return new LinkedHashSet<SurveyDefinition>(query.getResultList());
    }
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Set<SurveyDefinition> findAllPublishedInternal(String login, int startResult, int maxRows)
            throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.findAllPublishedForManagerInternal", startResult, maxRows);
        query.setParameter("login", login);
        return new LinkedHashSet<SurveyDefinition>(query.getResultList());
    }
    ...
    public SurveyDefinition findById(Long id) throws DataAccessException {
        try {
            Query query = createNamedQuery("SurveyDefinition.findById", -1, -1);
    ...
    public SurveyDefinition findByIdEager(Long id) throws DataAccessException {
        try {
            Query query = createNamedQuery("SurveyDefinition.findByIdEager", -1, -1);
            query.setParameter("id", id);
            return (SurveyDefinition) query.getSingleResult();
        } catch (NoResultException nre) {
            return null;
    ...
    public Set<SurveyDefinition> findByName(String name) throws DataAccessException {
        try {
            Query query = createNamedQuery("SurveyDefinition.findByName", -1, -1);
    ...
    public int deleteByDepartmentId(Long id) throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.deleteByDepartmentId", 0, 0);
        query.setParameter("id", id);
    ...
    @SuppressWarnings("unchecked")
    @Override
    public Set<SurveyDefinition> findAllPublishedExternal(String login, int startResult, int maxRows)
            throws DataAccessException {
        Query query = createNamedQuery("SurveyDefinition.findAllPublishedExternal", startResult, maxRows);
        query.setParameter("login", login);
        return new LinkedHashSet<SurveyDefinition>(query.getResultList());
    }
    ...
    @SuppressWarnings("unchecked")
    @Transactional
    public Set<SurveyDefinition> getSurveyDefinitionUsers(String login, int startResult, int maxRows)
            throws DataAccessException {
        try {
            Query query = createNamedQuery("SurveyDefinition.getSurveyDefinitionUsers", startResult, maxRows);
            query.setParameter("login", login);
            return new LinkedHashSet<SurveyDefinition>(query.getResultList());
        } catch (NoResultException nre) {
            return null;
