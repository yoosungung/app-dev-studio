...
<div id="personExcelUpload" style="display: none;">
                ...
                <tr>
                    ...
                    <td>
                        <div class="btnArea_center">
                            ...
                            <a href="${pageContext.request.contextPath}/survey/groupmanage/UserTemplates.xlsx" download><ui-button class="btn_excel">양식 다운로드</ui-button></a>
                        </div>
                    </td>
                </tr>
            </table>
...
<script>
vues.personExcelUpload = new Vue({
    el: '#personExcelUpload',
    data: {
        surveyGroupId: null,
        file: ''
    },
