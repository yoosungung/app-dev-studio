...
@Transactional
public class SurveyDefinitionPageDAOImpl extends AbstractJpaDao<SurveyDefinitionPage>
        implements SurveyDefinitionPageDAO {

    private final static Set<Class<?>> dataTypes = new HashSet<Class<?>>(
            Arrays.asList(new Class<?>[] { SurveyDefinitionPage.class }));
