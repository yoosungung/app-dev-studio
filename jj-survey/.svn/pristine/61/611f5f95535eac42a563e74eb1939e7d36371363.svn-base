...
public class UserService {
    ...
    @Autowired
    private SurveySecUserDefinitionMapper<?> secUserSurveyDefinitionMapper;
    ...
    public String user_prepareForgotPasswordMessage(Long id) {
        try {
            ...
            String hash = passwordEncoder.encode(user.getEmail() + new Date().getTime());
    ...
    public boolean user_validateForgotPasswordKey(String hash) {
        try {
            ...
            if (passwordResetRequest == null) {
                log.info("empty return" + hash);
            }
            if (passwordResetRequest != null && passwordResetRequest.getResetDate() == null) {
                int hours = Hours
                        .hoursBetween(new DateTime(passwordResetRequest.getRequestDate()), new DateTime(new Date()))
                        .getHours();
    ...
    public Set<User> user_findAll() {
        return userDAO.findAll();
    }

    public Set<User> user_findAll(int startResult, int maxRows) {
        return userDAO.findAll(startResult, maxRows);
    }

    public Set<User> user_findAllInternal() {
        return userDAO.findAllInternal();
    }

    public Set<User> user_findAllInternal(int startResult, int maxRows) {
        return userDAO.findAllInternal(startResult, maxRows);
    }

    public Set<User> user_findAllExternal() {
        return userDAO.findAllExternal();
    }

    public Set<User> user_findAllExternal(int startResult, int maxRows) {
        return userDAO.findAllExternal(startResult, maxRows);
    }

    public Set<User> user_findAllExternal(int startResult, int maxRows, String keywords) {
        return userDAO.findAllExternal(startResult, maxRows, keywords);
    }
    ...
    public Long user_getCountExternal(String keywords) {
        return userDAO.getCountExternal(keywords);
    }
    ...
    public Boolean user_ValidateLoginIsUnique(User user) {
    ...
    public Boolean user_ValidateEmailIsUnique(User user) {
    ...
    public Boolean user_ValidateGroupUserEmpty(User user) {
    ...
    public Boolean user_ValidateDepartmentUserEmpty(User user) {
        Boolean isValid = false;
    ...
    public Boolean user_ValidateSurveyDefinitionUserEmpty(User user) {
        Boolean isValid = false;
    ...
    public Set<Group> group_findAll(SecurityObject securityObject) {
    ...
    public Set<Group> group_findAll(int startResult, int maxRows) {
    ...
    public Set<User> user_findAll(SecurityObject securityObject) {
        if (securityObject != null) {
            if (securityObject.getType().equals(SecurityType.I)) {
                return userDAO.findAllInternal();
            } else
    ...
    public Boolean group_ValidateNameIsUnique(Group group) {
    ...
    public Set<Authority> authority_findAll(SecurityObject securityObject) {
        if (securityObject != null) {
            if (securityObject.getType().equals(SecurityType.I)) {
    ...
    public Set<Authority> authority_findAll(int startResult, int maxRows) {
    ...
    public Boolean authority_ValidateNameIsUnique(Authority authority) {
        Boolean isValid = true;
        // get all appplication types with the same name
    ...
    public List<SurveySecUserDefinition> getUserSurveyDefinitionsBySurveyDefinitionId(long surveyDefinitionId) {
        return secUserSurveyDefinitionMapper.getUserSurveyDefinitionsBySurveyDefinitionId(surveyDefinitionId);
    }

    // 사용자설문조사 전체삭제
    public int getUserSurveyDefinitionCount(Long surveyDefinitionId, Long userId) {
        return secUserSurveyDefinitionMapper.getUserSurveyDefinitionCount(surveyDefinitionId, userId);
    }

    // 사용자설문조사 전체삭제
    @Transactional(readOnly = false)
    public int delUserSurveyDefinitionsBySurveyDefinitionId(Long surveyDefiniitonId) {
        return secUserSurveyDefinitionMapper.delUserSurveyDefinitionsBySurveyDefinitionId(surveyDefiniitonId);
    }

    // 사용자설문조사 개별삭제
    @Transactional(readOnly = false)
    public int delUserSurveyDefinitionBySurveyDefinitionIdAndUserId(Long surveyDefinitionId, Long userId) {
        SurveySecUserDefinition userSurveyDefinition = new SurveySecUserDefinition();
        userSurveyDefinition.setSurveyDefinitionId(surveyDefinitionId);
        userSurveyDefinition.setUserId(userId);
        return secUserSurveyDefinitionMapper.delUserSurveyDefinitionBySurveyDefinitionIdAndUserId(userSurveyDefinition);
    }

    // 사용자설문조사 등록
    public int addUserSurveyDefinition(Long surveyDefinitionId, Long userId) {
        SurveySecUserDefinition userSurveyDefinition = new SurveySecUserDefinition();
        userSurveyDefinition.setSurveyDefinitionId(surveyDefinitionId);
        userSurveyDefinition.setUserId(userId);
        return secUserSurveyDefinitionMapper.addUserSurveyDefinition(userSurveyDefinition);
    }
