...
@Entity
@Table(name = "survey_sec_group")
@NamedQueries({ @NamedQuery(name = "Group.findAll", query = "select o from Group o order by o.type desc,o.name asc"),
        @NamedQuery(name = "Group.findAllInternal", query = "select o from Group o where o.type = com.jd.survey.domain.security.SecurityType.I order by o.name asc"),
        @NamedQuery(name = "Group.findAllExternal", query = "select o from Group o where o.type = com.jd.survey.domain.security.SecurityType.E order by o.name asc"),
...
public class Group implements Comparable<Group>, Serializable, SecurityObject {
    ...
    @Id
    // @SequenceGenerator(name = "seqSecGroup", sequenceName="seq_survey_sec_group")
    // @GeneratedValue(strategy = GenerationType.SEQUENCE, generator="seqSecGroup")
    ...
    @JoinTable(name = "survey_sec_group_authority", joinColumns = {
