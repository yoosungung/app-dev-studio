...
@RequestMapping("/statistics/details")
@Controller
public class StatisticsDetailsController {

    // ~ Static fields/initializers
    // =========================================================

    private static final Log log = LogFactory.getLog(StatisticsDetailsController.class);
    ...
    public String listSurveys(Model uiModel, Principal principal) {
        try {
            ...
            return "statistics/surveys/entries";
        } catch (Exception e) {
    ...
    public String showSurvey(@PathVariable("id") Long surveyId, Principal principal, Model uiModel,
        ...
        try {
            ...
            return "statistics/surveys/survey";
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            throw (new RuntimeException(e));
        }
    ...
    public ModelAndView exportSurveyToPdf(@PathVariable("id") Long surveyId, Principal principal,
        ...
        try {
            ...
            // surveySettingsService.surveyDefinition_findById(surveyEntry.getSurveyDefinitionId());
            List<SurveyPage> surveyPages = surveyService.surveyPage_getAll(surveyId,
                    messageSource.getMessage(DATE_FORMAT, null, LocaleContextHolder.getLocale()));
            ...
            modelAndView.addObject("falseMessage",
                    messageSource.getMessage("false_message", null, LocaleContextHolder.getLocale()));
            modelAndView.addObject("trueMessage",
                    messageSource.getMessage("true_message", null, LocaleContextHolder.getLocale()));
            modelAndView.addObject("dateFormat",
                    messageSource.getMessage("date_format", null, LocaleContextHolder.getLocale()));

            Map<String, String> surveyEntryLabels = new HashMap<String, String>();
            surveyEntryLabels.put("surveyEntryLabel", messageSource.getMessage("com.jd.survey.domain.surveyentry_label",
                    null, LocaleContextHolder.getLocale()));
            surveyEntryLabels.put("surveyNameLabel", messageSource.getMessage(
                    "com.jd.survey.domain.surveyentry.surveyname_label", null, LocaleContextHolder.getLocale()));
            surveyEntryLabels.put("surveyIdLabel", messageSource.getMessage(
                    "com.jd.survey.domain.surveyentry.surveyid_label", null, LocaleContextHolder.getLocale()));
            surveyEntryLabels.put("createdByLabel", messageSource.getMessage(
                    "com.jd.survey.domain.surveyentry.createdbyfullname_label", null, LocaleContextHolder.getLocale()));
            surveyEntryLabels.put("creationDateLabel", messageSource.getMessage(
                    "com.jd.survey.domain.surveyentry.creationdate_label", null, LocaleContextHolder.getLocale()));
            surveyEntryLabels.put("lastUpdateDateLabel", messageSource.getMessage(
                    "com.jd.survey.domain.surveyentry.lastupdatedate_label", null, LocaleContextHolder.getLocale()));
            surveyEntryLabels.put("submissionDateLabel", messageSource.getMessage(
                    "com.jd.survey.domain.surveyentry.submissiondate_label", null, LocaleContextHolder.getLocale()));
    ...
    public String listSurveysForExport(Model uiModel, Principal principal) {
        try {
            ...
            return "statistics/surveys/surveys";
        } catch (Exception e) {
            log.error(e.getMessage(), e);
            throw (new RuntimeException(e));
        }
    ...
    public void getQuestionDocument(@PathVariable("Id") Long surveyDocumentId, Principal principal,
        ...
        try {
            ...
            // surveyDocument.getFileName());
            response.setHeader("Content-Disposition", "attachment;filename=" + surveyDocument.getFileName());
