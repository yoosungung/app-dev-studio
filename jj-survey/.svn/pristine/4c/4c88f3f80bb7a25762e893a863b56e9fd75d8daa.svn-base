...
@Entity
@Table(name = "survey_global_settings")
@NamedQueries({ @NamedQuery(name = "GlobalSettings.findAll", query = "select o from GlobalSettings o"),
...
public class GlobalSettings {
    ...
    @Id
    // @SequenceGenerator(name = "seqGlobalSettings",
    // sequenceName="seq_global_settings")
