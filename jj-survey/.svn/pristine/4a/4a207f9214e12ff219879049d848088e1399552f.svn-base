...
public class RegularExpressionController {
    ...
    public String createPost() {
        return "admin/masks/saved";
    }

    @Secured({ "ROLE_ADMIN" })
    @RequestMapping(params = "create", produces = "text/html")
    public String createRegularExpression(Principal principal, Model uiModel, HttpServletRequest httpServletRequest) {
    ...
    public String createPost(@RequestParam(value = "_proceed", required = false) String proceed,
            @Valid RegularExpression regularExpression, BindingResult bindingResult, Principal principal, Model uiModel,
        ...
        try {
            ...
            if (proceed != null) {
                ...
                return "redirect:/admin/masks/saved";// + encodeUrlPathSegment(regularExpression.getId().toString(),
                                                     // httpServletRequest);
            } else {
    ...
    public String show(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page,
        ...
        try {
            ...
            uiModel.addAttribute("regularExpressions",
                    surveySettingsService.regularExpression_findAll(firstResult, sizeNo));
    ...
    void populateEditForm(Model uiModel, RegularExpression regularExpression, User user) {
