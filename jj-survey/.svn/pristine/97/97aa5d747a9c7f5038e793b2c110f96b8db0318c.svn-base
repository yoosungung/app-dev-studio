...
@Entity
@Table(name = "survey_data_set_item")
@NamedQueries({ @NamedQuery(name = "DataSetItem.findAll", query = "select o from DataSetItem o"),
...
public class DataSetItem implements Comparable<DataSetItem>, Serializable {
    ...
    @Id
    // @SequenceGenerator(name = "seqDataSetItem",
    // sequenceName="seq_survey_data_set_item")
