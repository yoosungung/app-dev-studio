...
public class StatisticsPdf extends AbstractPdfView {
    ...
    private void writeCurrencyEntry(Document document, String label, double value) throws Exception {
        ...
        questionParagraph.add(
                new Chunk(CurrencyValidator.getInstance().format(value, LocaleContextHolder.getLocale()), normalFont));
        document.add(questionParagraph);
    }
                ...
                for (QuestionStatistic questionStatistic : questionStatistics) {
                    if (questionStatistic.getRowOrder().equals(rowLabel.getOrder())
                        ...
                        cell.add(new Paragraph(
                                trueLabel + ": " + percentFormat.format(questionStatistic.getFrequency()), normalFont));
                        found = true;
                        break;
                    }
                }
    ...
    private void writeNumericMatrixQuestionStatistics(Document document, Question question,
            List<QuestionStatistic> questionStatistics, String minimumLabel, String maximumLabel, String averageLabel,
            String standardDeviationLabel) throws Exception {
                ...
                for (QuestionStatistic questionStatistic : questionStatistics) {
                    if (questionStatistic.getRowOrder().equals(rowLabel.getOrder())
                        ...
                        cell.add(new Paragraph(
                                ...
                                normalFont));
                        cell.add(new Paragraph(standardDeviationLabel + ": " + BigDecimalValidator.getInstance().format(
                                questionStatistic.getSampleStandardDeviation(), LocaleContextHolder.getLocale()),
                                normalFont));
                        break;
                    }
                }
                    ...
                    if (questionStatistic.getRowOrder().equals(rowLabel.getOrder())
                        ...
                        cell.add(new Paragraph(
                                averageLabel + ": " + CurrencyValidator.getInstance()
                                        .format(questionStatistic.getAverage(), LocaleContextHolder.getLocale()),
                                normalFont));
                        cell.add(new Paragraph(standardDeviationLabel + ": " + CurrencyValidator.getInstance().format(
                                questionStatistic.getSampleStandardDeviation(), LocaleContextHolder.getLocale()),
                                normalFont));
