...
/**
 * + A modified AbstractJExcelView class to handle an error in reading user name
 * in linux environment. Only method modidied is renderMergedOutputModel
 * * @author JD Software
 **/
public abstract class AbstractJExcelView2 extends AbstractView {
    ...
    protected final void renderMergedOutputModel(Map<String, Object> model, HttpServletRequest request,
        ...
        if (this.url != null) {
            ...
            // this was modified from the standard AbstractJExcelView2 spring library to
            // handle an error parsing out the
     ...
     * 
     * @param url     the URL of the Excel template without localization part nor
     *                extension
