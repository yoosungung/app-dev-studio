...
<div id="list" style="display: none;">
    <div class="pageHeader">
        ...
        <div class="btn_area">
            ...
            <ui-button class="btn_write" onclick="vues.list.viewSortList();">정렬 설정</ui-button>
            <ui-button class="btn_write" onclick="vues.list.viewHierarchyList();">권한계층 편집</ui-button>
        </div>
    </div>
    ...
    <div class="pageContents">
        ...
        <ui-grid-paging v-bind:request="gridRequest" v-bind:result="gridResult" v-bind:read-list="service.readList">
            <table class="bbs_list">
                <thead>
                    <tr>
                        <th width="250px" column-name="authorCode">권한 코드</th>
                        <th width="180px" column-name="authorNm">권한 이름</th>
                        <th width="100px" column-name="authorMenuCnt">권한별 메뉴 갯수</th>
                        <th width="130px" column-name="authorResrceCnt">권한별 프로그램 갯수</th>
                        <th width="100px" column-name="authorUserCnt">권한별 사용자 수</th>
                        <th width="60px" column-name="sortOrdr">정렬 순서</th>
                        <th width="100px" column-name="userAuthorYnNm">사용자 권한 여부</th>
                        <th width="60px" column-name="useYnNm">사용 여부</th>
                    </tr>
                </thead>
                <tbody v-cloak>
...
vues.list = new Vue({
    ...
    methods: {
        ...
        viewSortList: function() {
            CommonUtil.popupVue("sort");
        },
        // 권한계층 편집 화면
        viewHierarchyList: function() {
            CommonUtil.popupVue("hierarchy");
        }
    }
});
</script>
