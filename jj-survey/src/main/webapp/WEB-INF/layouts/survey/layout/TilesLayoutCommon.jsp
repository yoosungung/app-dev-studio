...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/survey/common/ui/layout.css">
    <link rel="stylesheet" type="text/css" href="${pageContext.request.contextPath}/survey/common/ui/style.css">
...
<body>
    <div id="wrap">
        ...
        <div id="header">
            <%@ include file="/WEB-INF/layouts/survey/include/TilesIncludeHeader.jspf" %>
        </div>
        <div id="container">
            <!-- 왼쪽메뉴 시작 -->
            <div class="pageLeft">
                <%@ include file="/WEB-INF/layouts/survey/include/TilesIncludeSidebar.jspf" %>
            </div>
