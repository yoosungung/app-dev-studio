...
public class SurveyStatistic {
    ...
    public SurveyStatistic(Long surveyDefinitionId, String surveyName, String departmentName, Long icompletedCount,
            Long submittedCount, Long deletedCount, Long totalCount) {
        super();
