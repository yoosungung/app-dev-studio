...
@Entity
@Table(name = "survey_question_column_label")
@NamedQueries({ @NamedQuery(name = "QuestionColumnLabel.findAll", query = "select o from QuestionColumnLabel o"),
...
public class QuestionColumnLabel
        implements Comparable<QuestionColumnLabel>, Serializable, SortedSetUpdater.InrementableCompartator {
    ...
    @Id
    // @SequenceGenerator(name = "seqQuestionColumnLabel",
    // sequenceName="seq_survey_question_col_label")
    // @GeneratedValue(strategy = GenerationType.SEQUENCE, generator =
    // "seqQuestionColumnLabel")
    ...
    private QuestionColType type = QuestionColType.SHORT_TEXT_INPUT;
    ...
    public QuestionColumnLabel(Question question, Short order, String label, QuestionColType type) {
        super();
        this.question = question;
        this.order = order;
        this.label = label;
    ...
    public QuestionColType getType() {
        return type;
    }

    public void setType(QuestionColType type) {
        this.type = type;
    }
