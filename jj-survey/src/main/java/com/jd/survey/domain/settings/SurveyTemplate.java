...
@Entity
@NamedQueries({ @NamedQuery(name = "SurveyTemplate.findAll", query = "select o from SurveyTemplate o"),
...
public class SurveyTemplate implements Comparable<SurveyTemplate>, Serializable {
    ...
    @Id
    // @SequenceGenerator(name = "seqSurveyTemplate",
    // sequenceName="seq_servey_template")
