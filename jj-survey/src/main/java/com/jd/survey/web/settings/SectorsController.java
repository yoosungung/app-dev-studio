...
public class SectorsController {
    ...
    public String createPost(@RequestParam(value = "_proceed", required = false) String proceed, @Valid Sector sector,
    ...
    public String show(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page,
        ...
        try {
            ...
            uiModel.addAttribute("surveyTemplates",
                    surveySettingsService.surveyTemplate_findBySectorId(id, firstResult, sizeNo));
    ...
    public String deletess(@PathVariable("id") Long id, Principal principal, Model uiModel,
        ...
        try {
            ...
            SurveyTemplate surveyTemplate = surveySettingsService.surveyTemplate_findById(id);
    ...
    void populateEditForm(Model uiModel, Sector sector, User user) {
