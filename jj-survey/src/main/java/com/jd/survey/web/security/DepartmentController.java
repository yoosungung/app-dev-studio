...
public class DepartmentController {
    ...
    public String createPost() {
        return "security/departments/saved";
    }
    ...
    public String createPost(@RequestParam(value = "_proceed", required = false) String proceed,
        ...
        try {
            ...
            if (proceed != null) {
                ...
                return "redirect:/security/departments/saved";
            } else {
    ...
    public String update(@RequestParam(value = "_proceed", required = false) String proceed,
        ...
        try {
            ...
            if (proceed != null) {
                ...
                if (surveySettingsService.department_findByName(department.getName()) != null && !surveySettingsService
                        .department_findByName(department.getName()).getId().equals(department.getId())) {
                    bindingResult.rejectValue("name", "field_unique");
                    populateEditForm(uiModel, department, user);
                    return "security/departments/update";
                }
    ...
    public String delete(@PathVariable("id") Long id, @RequestParam(value = "page", required = false) Integer page,
            @RequestParam(value = "size", required = false) Integer size, Principal principal, User user,
            Model uiModel) {
    ...
    void populateEditForm(Model uiModel, Department department, User user) {
