...
public class SurveyDefinitionController {
    ...
    public String show(@PathVariable("id") Long surveyDefinitionId, Principal principal, Model uiModel,
            HttpServletRequest httpServletRequest) {

        System.out.println("조회함..... " + surveyDefinitionId);
        ...
        try {
            ...
            String surveyLink = RequestContextUtil.getContextURL() + "/survey/" + surveyDefinitionId;
            ...
            uiModel.addAttribute("itemId", surveyDefinitionId);
