        ...
        try {
            if (proceed != null) {
                ...
                if (httpServletRequest.getRequestURI().contains("external")) {
                    // resetPasswordLink =messageSource.getMessage(EXTERNAL_SITE_BASE_URL, null,
                    // LocaleContextHolder.getLocale());
                    resetPasswordLink = RequestContextUtil.getContextURL() + "/surveys";
                } else {
                    // resetPasswordLink =messageSource.getMessage(INTERNAL_SITE_BASE_URL, null,
                    // LocaleContextHolder.getLocale());
                    resetPasswordLink = RequestContextUtil.getContextURL() + "/admin";
                }
                ...
                model.put(
                        messageSource
                                .getMessage(RESET_PASSWORD_LINK_PARAMETER_NAME, null, LocaleContextHolder.getLocale())
                                .replace("${", "").replace("}", ""),
