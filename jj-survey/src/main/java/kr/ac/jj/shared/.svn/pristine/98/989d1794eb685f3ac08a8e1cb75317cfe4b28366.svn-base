...
import kr.ac.jj.shared.interfaces.admin.appmanage.hrmanage.mapper.HumanResourceManageUserIntrfcMapper;
...
public class HumanResourceManageServiceNoTxImpl {
    ...
    private @Autowired HumanResourceManageUserIntrfcMapper humanResourceManageUserIntrfcMapper;
    ...
    public void createOrUpdatePersonList(String userId) {
        ...
        humanResourceManageUserIntrfcMapper.updateList();

        if (StringUtils.isEmpty(userId)) {
            humanResourceManageUserIntrfcMapper.updateListUseYnTo0(sharedConfig.getLogin().getUserPersonSe());
        }

        humanResourceManageUserIntrfcMapper.insertList(sharedConfig.getLogin().getUserPersonSe());
    ...
    public void createOrUpdateDeptEmployeeList() {
        ...
        humanResourceManagePersonDeptIntrfcMapper.insertList(DeptSeEnums.EMPLOYEE);
        humanResourceManagePersonDeptIntrfcMapper.updateList(DeptSeEnums.EMPLOYEE);
        humanResourceManagePersonDeptIntrfcMapper.deleteList(DeptSeEnums.EMPLOYEE);
    }
    ...
    public void createOrUpdateDeptStudentList() {
        ...
        humanResourceManagePersonDeptIntrfcMapper.insertList(DeptSeEnums.STUDENT);
        humanResourceManagePersonDeptIntrfcMapper.updateList(DeptSeEnums.STUDENT);
        humanResourceManagePersonDeptIntrfcMapper.deleteList(DeptSeEnums.STUDENT);
    }
