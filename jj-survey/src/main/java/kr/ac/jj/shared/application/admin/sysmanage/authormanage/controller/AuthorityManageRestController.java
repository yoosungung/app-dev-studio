...
public class AuthorityManageRestController {
     ...
     * @return
     */
    @GetMapping(path = "/readDeptTreeList")
    public List<Map<String, Object>> readDeptTreeList() {
        return authorityManageService.readDeptTreeList();
    }
     ...
     * @param gridRequest
     */
    @PostMapping(path = "/readDutySearchList")
    public void readDutySearchList(@RequestBody GridRequest gridRequest) {
        authorityManageService.readDutySearchList(gridRequest);
    }
