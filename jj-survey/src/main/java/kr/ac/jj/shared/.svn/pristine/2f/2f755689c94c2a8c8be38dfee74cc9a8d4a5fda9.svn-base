...
public class ReloadableAllBasenamesMessageSource extends ReloadableResourceBundleMessageSource {
    ...
    public String getInvalidSuffix() {
        return this.invalidSuffix;
    }

    public void setInvalidSuffix(String invalidSuffix) {
    ...
    public Properties getMergedPropertiesProperties(Locale locale) {
