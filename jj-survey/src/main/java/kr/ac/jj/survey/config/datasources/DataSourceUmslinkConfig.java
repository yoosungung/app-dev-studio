...
@Configuration
public class DataSourceUmslinkConfig {

    @Bean(name = "hikariConfig.umslink")
    @ConfigurationProperties(prefix = "config.survey.datasources.umslink.hikari")
    public HikariConfig hikariConfig() {
        return new HikariConfig();
    }

    @Bean(name = "jndiConfig.umslink")
    @ConfigurationProperties(prefix = "config.survey.datasources.umslink.jndi")
    public JndiConfig jndiConfig() {
        return new JndiConfig();
    }

    @Bean(name = "myBatisConfig.umslink")
    @ConfigurationProperties(prefix = "config.survey.datasources.umslink.mybatis")
    public MyBatisConfigProperties myBatisConfig() {
        return new MyBatisConfigProperties();
    }

    @Bean(name = "realDataSource.umslink")
    ...
    @Bean(name = "dataSource.umslink")
    public DataSource dataSource() {
        return new DataSourceSpy(realDataSource());
    }

    @Bean(name = "sqlSession.umslink")
    public SqlSessionTemplate sqlSession() {
        return new SqlSessionTemplate(sqlSessionFactory());
    }

    @Bean(name = "sqlSessionFactory.umslink")
    ...
    @MapperScan(annotationClass = UmslinkSqlMapper.class, sqlSessionFactoryRef = "sqlSessionFactory.umslink", basePackages = {
            "kr.ac.jj.survey" })
    ...
    @Documented
    @Component
    public @interface UmslinkSqlMapper {
