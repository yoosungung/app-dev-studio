...
export default function UserManageList() {
    ...
    return (
        <ListPageContainer listExact={match.isExact}>
            <ListPageHeader
                title={message.get("admin.appmanage.usermanage.title.list", "사용자 현황")}
                buttons={
            ...
            <ListSearchForm readList={readList}>
                <table className="form">
                    ...
                    <tbody>
                        <tr>
                            <th>{message.get("domain.main.tbComPerson.koreanNm.normal", "서비스명")}</th>
                            <td>
                                <InputGroup
                                    name="bbsCode"
                            ...
                            <th>{message.get("domain.main.tbComPerson.emplNo.normal", "교/학번")}</th>
                            <td>
                                <InputGroup
                                    name="bbsNm"
                                    onChange={handleSearchConditionValues}
                ...
                <DataGrid
                    grid={{
                        columns: [
                            ...
                            {
                                key: "KOREAN_NM",
                                name: `${message.get("domain.main.tbComPerson.koreanNm.normal", "서비스명")}`,
                                width: 200,
                                resizable: true,
                            ...
                            {
                                key: "emplNo",
                                name: `${message.get("domain.main.tbComPerson.emplNo.normal", "내용")}`,
                                resizable: true
                            },
                            {
                                key: "emailAdres",
                                name: `${message.get("domain.main.tbComPerson.emailAdres.normal", "최종수정일")}`,
                                width: 120,
                                resizable: true
                            },
                        ],
