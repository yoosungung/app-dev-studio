...
var Navigator = /** @class */ (function (_super) {
    ...
    function Navigator() {
        ...
        _this.renderItem = function (section, props) {
            ...
            var pathElements = section.path.reduce(function (elems, el) {
                elems.push(el, React.createElement(core_1.Icon, { key: el, icon: "caret-right" }));
                return elems;
            }, []);
            pathElements.pop();
    ...
    Navigator.prototype.render = function () {
        ...
        return (React.createElement(NavOmnibar, { className: "docs-navigator-menu", inputProps: INPUT_PROPS, itemListPredicate: this.filterMatches, isOpen: this.props.isOpen, items: this.sections, itemRenderer: this.renderItem, onItemSelect: this.handleItemSelect, onClose: this.props.onClose, resetOnSelect: true }));
    };
    return Navigator;
}(React.PureComponent));
