...
export class Example extends React.PureComponent {
    constructor() {
        super(...arguments);
        this.hasDelayedInitialRender = false;
    }
    render() {
        ...
        const example = html == null ? (React.createElement("div", { className: "docs-example" }, children)) : (React.createElement("div", { className: "docs-example", dangerouslySetInnerHTML: { __html: html } }));
        return (React.createElement("div", Object.assign({ className: classes, "data-example-id": id }, htmlProps),
            example,
