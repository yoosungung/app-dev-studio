...
var Table = /** @class */ (function (_super) {
    ...
    function Table(props, context) {
        ...
        _this.bodyCellRenderer = function (rowIndex, columnIndex) {
            ...
            var _a = cell.props.loading, loading = _a === void 0 ? _this.hasLoadingOption(loadingOptions, regions_2.ColumnLoadingOption.CELLS) : _a;
    ...
    Table.getDerivedStateFromProps = function (props, state) {
        ...
        if (!core_1.Utils.deepCompareKeys(state, nextState, Table_1.SHALLOW_COMPARE_STATE_KEYS_BLACKLIST)) {
            return nextState;
        }
        return null;
    };
