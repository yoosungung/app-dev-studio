...
export declare class Table extends AbstractComponent2<ITableProps, ITableState, ITableSnapshot> {
    static displayName: string;
    static defaultProps: ITableProps;
    static childContextTypes: React.ValidationMap<IColumnInteractionBarContextTypes>;
    static getDerivedStateFromProps(props: ITableProps, state: ITableState): {
    ...
    componentDidUpdate(prevProps: ITableProps, prevState: ITableState, snapshot: ITableSnapshot): void;
    protected validateProps(props: ITableProps): void;
