 ...
 * 코드 관리 Service
 */
export default class CodeManageService {
    private readonly path = "/admin/sysmanage/codemanage/CodeManage";
     ...
     * @param codeGroupId
     */
    public async read(codeGroupId: string) {
     ...
     * @param callback
     */
    public create(model: CodeManageModel, callback: Function) {
     ...
     * @param callback
     */
    public update(model: CodeManageModel, callback: Function) {
        const { messageStore: message, notifyStore } = StoreUtil.useStores();
     ...
     * @param codeGroupId
     */
    public delete(codeGroupId: string, callback: Function) {
        const { messageStore: message, notifyStore } = StoreUtil.useStores();
