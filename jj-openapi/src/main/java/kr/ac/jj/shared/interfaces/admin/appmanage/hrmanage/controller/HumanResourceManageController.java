package kr.ac.jj.shared.interfaces.admin.appmanage.hrmanage.controller;

import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Controller;

import kr.ac.jj.shared.interfaces.admin.appmanage.hrmanage.service.HumanResourceManageServiceNoTxImpl;
...
public class HumanResourceManageController {
    ...
    public void createOrUpdateAll() {
        ...
        try {
            ...
            humanResourceManageServiceNoTx.createOrUpdateDeptEmployeeList();
            humanResourceManageServiceNoTx.createOrUpdateDeptStudentList();
        } finally {
            this.working = false;
        }
    }
