 ...
 * 게시판 - FAQ Entity
 */
abstract class TbBbsFaqEntity extends MainEntity {

    private static final long serialVersionUID = -3261969378442319648L;

    protected String bbscttId;
    protected Long bbscttNo;
    protected String bbscttSj;
    protected String bbscttCn;
    protected String bbscttCn2;
    ...
    public String getBbscttCn2() {
        return this.bbscttCn2;
    }

    public void setBbscttCn2(String bbscttCn2) {
        this.bbscttCn2 = bbscttCn2;
    }
