...
public class CodeDataUtil {
    ...
    public static String getCodeName(String codeDataPath, Boolean codeValue, String defaultText, Locale locale) {
        ...
        CodeDataSourceAccessor codeDataSourceAccessor = getCodeDataSourceAccessor();
        BaseMapList codeDataList = codeDataSourceAccessor.getList(codeDataPath, locale);
        String booleanCode = codeDataSourceAccessor.getBooleanCode(codeDataList, codeValue);
