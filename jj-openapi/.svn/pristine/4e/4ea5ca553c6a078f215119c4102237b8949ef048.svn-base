...
<div class="loginArea" style="display: none;" v-on:keyup.enter="service.login();">
    <div class="loginBox">
        <div class="loginCon">
            ...
            <ui-valid-checker v-bind:value="model.loginNm" check="required" style="position: absolute; left: 3.2em; top: 1.0em;"></ui-valid-checker>
            ...
            />
            <ui-valid-checker v-bind:value="model.loginPassword" check="required" style="position: absolute; left: 3.2em; top: 5.2em;"></ui-valid-checker>
