...
<div id="read" style="display: none;">
    ...
    <div class="pageContents">
        ...
        <h3 v-if="model.tbApiSvcKey.sttus =='R'">반려 정보</h3>
        <table v-if="model.tbApiSvcKey.sttus =='R'" class="form">
            <colgroup>
                <col width="120px">
                <col width="">
                <col width="120px">
        ...
        <div class="page-space tar">
            <ui-button class="page" v-on:click="viewEdit();" v-if="model.editable && model.tbApiSvcKey.sttus =='A'">수정</ui-button>
            <ui-button class="page" v-on:click="service['delete']();" v-if="model.editable && model.tbApiSvcKey.sttus =='A'">삭제</ui-button>
