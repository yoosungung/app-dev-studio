package kr.ac.jj.survey.application.common.menu.controller;
...
import kr.ac.jj.survey.application.common.menu.service.MenuLoadServiceImpl;
...
public class MenuLoadRestController {
     ...
     * @return
     */
    @GetMapping(value = "/{menuKnd}/readAllList")
