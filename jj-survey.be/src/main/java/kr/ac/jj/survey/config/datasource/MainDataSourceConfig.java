...
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.interceptor.BaseSqlInterceptor;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.interceptor.DataResultHandleInterceptor;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.interceptor.DataUpdatedCheckInterceptor;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.interceptor.SelectQueryWrappingInterceptor;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.interceptor.StatementLogInterceptor;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.scripting.SelectQueryWrappingLanguageDriver;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.type.EmptyToNullTypeHandler;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.type.LONGVARCHARTypeHandler;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.type.LocaleStringTypeHandler;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.type.StringDateTypeHandler;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.dao.variables.MyBatisDataSourceSpec;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.datasource.config.MapperLocationResources;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.datasource.config.TransactionInterceptorFactory;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.datasource.props.DatabaseIdProperties;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.datasource.props.MyBatisConfigProperties;
import kr.ac.jj.survey.infrastructure.framework.web.persistence.dao.variables.WebSqlVariables;
import kr.ac.jj.survey.infrastructure.user.AnonymousUser;
import kr.ac.jj.survey.infrastructure.user.SystemUser;
