package kr.ac.jj.survey.application.common.codedata;
...
import kr.ac.jj.survey.infrastructure.framework.web.support.codedata.RequestCode;
...
public class CodeDataRestController {
    ...
    public Map<String, Object> read(@RequestBody List<RequestCode> requestCodeList) {
        return CodeDataUtil.getCodeDataMap(requestCodeList, RequestContextUtil.getLocale());
    }
}
