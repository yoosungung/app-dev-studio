...
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.datasource.props.MyBatisConfigProperties.IsolationLevelNames;
import kr.ac.jj.survey.infrastructure.framework.mybatis.persistence.datasource.props.MyBatisConfigProperties.Transaction;
