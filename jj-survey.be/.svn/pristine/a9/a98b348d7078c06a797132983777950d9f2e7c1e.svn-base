package kr.ac.jj.survey.application.admin.sysmanage.resrcemanage.service;
...
import kr.ac.jj.survey.application.admin.sysmanage.resrcemanage.mapper.ResourceManageMapper;
import kr.ac.jj.survey.application.admin.sysmanage.resrcemanage.model.ResourceManageModel;
import kr.ac.jj.survey.domain.main.mapper.sys.resrce.TbSysResrceMapper;
...
public class ResourceManageServiceImpl {
    ...
    public ResourceManageModel read(String resrceId) {
        ...
        if (StringUtils.isNotEmpty(resrceId)) {
