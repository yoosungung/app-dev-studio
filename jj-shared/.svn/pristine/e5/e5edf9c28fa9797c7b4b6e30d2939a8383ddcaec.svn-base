package kr.ac.jj.shared.infrastructure.framework.mybatis.persistence.dao.variables;
...
import kr.ac.jj.shared.infrastructure.framework.core.persistence.dao.variables.DataSourceSpec;
