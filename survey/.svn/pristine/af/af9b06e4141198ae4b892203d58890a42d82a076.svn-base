...
public class VelocityTemplate implements  Serializable {
	...
	@Id
	//@SequenceGenerator(name = "seqVelocityTemplate", sequenceName="seq_survey_velocity_template")
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqVelocityTemplate")
