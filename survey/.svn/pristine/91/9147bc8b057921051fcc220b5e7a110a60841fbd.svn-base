...
public class UserService {
	...
	@Autowired private SurveySecUserDefinitionMapper<?> secUserSurveyDefinitionMapper;
	...
	public Set<User> user_findAllExternal(int startResult,int maxRows, String keywords) throws DataAccessException {
	...
	public Set<Group> group_findAll(SecurityObject securityObject) throws DataAccessException {
		if (securityObject != null) {
			...
			else return groupDAO.findAllExternal();
		}
		else return groupDAO.findAll();
	}
	...
	public Set<User> user_findAll(SecurityObject securityObject ) throws DataAccessException {
		if(securityObject != null) {
			...
			else return userDAO.findAllExternal();
		}
		else return userDAO.findAll();
	}
	...
	public Set<Authority> authority_findAll(SecurityObject securityObject ) throws DataAccessException {
		if(securityObject != null) {
			...
			else return authorityDAO.findAllExternal();
		}
		else return authorityDAO.findAll();
	}
