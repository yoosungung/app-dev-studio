...
public class SurveyDefinitionService {
	...
	@Autowired private SurveyDefinitionMapper<Serializable> surveyDefinitionMapper;
	
	@Autowired private SurveySecUserDefinitionMapper<Serializable> surveySecUserDefinitionMapper;
	...
	public List<SurveyDefinition> getMainRealSurveyDefinitionListByLogin(String login) {
		...
		if(login != null) {
			...
			for(SurveyDefinition realSurveyDefinition : mainRealSurveyDefinitionList) {
				for(SurveyDefinition userSurveyDefinition : surveyDefinitionMapper.getRealSurveyDefinitionListByLogin(login)) {
