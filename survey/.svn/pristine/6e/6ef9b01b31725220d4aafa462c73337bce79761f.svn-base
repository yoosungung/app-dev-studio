...
public class PasswordResetRequest implements Serializable {
	...
	@Id
	//@SequenceGenerator(name = "seqSecPasswordResetRequest", sequenceName="seq_sec_password_reset_request")
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqSecPasswordResetRequest")
