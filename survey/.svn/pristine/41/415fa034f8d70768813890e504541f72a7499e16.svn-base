...
public class QuestionRowLabel implements Comparable <QuestionRowLabel>,  Serializable, SortedSetUpdater.InrementableCompartator{
	...
	@Id
	//@SequenceGenerator(name = "seqQuestionRowLabel", sequenceName="seq_survey_question_row_label")
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqQuestionRowLabel")
