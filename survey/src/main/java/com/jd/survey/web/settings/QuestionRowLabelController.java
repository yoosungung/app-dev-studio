...
public class QuestionRowLabelController {
	...
	public String updateForm(@PathVariable("id") Long questionId, Principal principal, Model uiModel, HttpServletRequest httpServletRequest) {
		try{
	...
	public String createPost(Question question,
			BindingResult bindingResult, @RequestParam(value="_proceed", required = false) String proceed,
