...
public class RegularExpressionController {
	...
	public String createPost(@RequestParam(value = "_proceed", required = false) String proceed,
			@Valid RegularExpression regularExpression, BindingResult bindingResult,
		...
		try {			
			...
			if(proceed != null){
				...
				return "redirect:/admin/masks/saved" ;//+ encodeUrlPathSegment(regularExpression.getId().toString(), httpServletRequest);
			}
			else {
