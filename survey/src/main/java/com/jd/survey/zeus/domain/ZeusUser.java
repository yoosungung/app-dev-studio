...
public class ZeusUser extends BaseBean {
	...
	public String getGrade() {
		String str = "";
		if(this.grade.equals("ZEUS_USER")) str = "일반사용자";
		else if(this.grade.equals("ZEUS_TEMP_PW")) str = "임시비밀번호회원";
		else if(this.grade.equals("ZEUS_EQUIP")) str = "장비담당자";
		else if(this.grade.equals("ZEUS_CLOUD")) str = "기관담당자";
		else if(this.grade.equals("ZEUS_CALL")) str = "온라인상담담당자";
		else if(this.grade.equals("ZEUS_PRIVACY_MASTER")) str = "개인정보담당관";
		else if(this.grade.equals("ZEUS_SYS_MASTER")) str = "시스템관리자";
		return str;
	}
