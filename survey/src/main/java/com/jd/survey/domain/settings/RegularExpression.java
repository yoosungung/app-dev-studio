...
public class RegularExpression implements Serializable {
	...
	@Id
	//@SequenceGenerator(name = "seqReqularExpression", sequenceName="seq_survey_regular_expression")
	//@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqReqularExpression")
