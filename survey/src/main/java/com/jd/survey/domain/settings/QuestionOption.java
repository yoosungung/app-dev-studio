...
public class QuestionOption implements Comparable <QuestionOption>,  Serializable, SortedSetUpdater.InrementableCompartator{
	...
	@Id
	//@SequenceGenerator(name = "seqQuestionOption", sequenceName="seq_survey_question_option")
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqQuestionOption")
