...
public class QuestionColumnLabel implements Comparable <QuestionColumnLabel>,  Serializable, SortedSetUpdater.InrementableCompartator{
	...
	@Id
	//@SequenceGenerator(name = "seqQuestionColumnLabel", sequenceName="seq_survey_question_col_label")
    //@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "seqQuestionColumnLabel")
